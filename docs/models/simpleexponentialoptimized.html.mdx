---
description: Step-by-step guide on using the `SimpleExponentialSmoothingOptimized
  Model` with `Statsforecast`.
...
![](SimpleExponentialOptimized_files/figure-markdown_strict/cell-7-output-1.png)
...
![](SimpleExponentialOptimized_files/figure-markdown_strict/cell-8-output-1.png)
...
![](SimpleExponentialOptimized_files/figure-markdown_strict/cell-11-output-1.png)
...
`SimpleExponentialSmoothingOptimized Model`, they are listed below. For
more information, visit the
[documentation](https://nixtla.github.io/statsforecast/src/core/models.html#simplesmooth).
...
![](SimpleExponentialOptimized_files/figure-markdown_strict/cell-18-output-1.png)
...
![](SimpleExponentialOptimized_files/figure-markdown_strict/cell-21-output-1.png)
...
![](SimpleExponentialOptimized_files/figure-markdown_strict/cell-26-output-1.png)
...
![](SimpleExponentialOptimized_files/figure-markdown_strict/cell-27-output-1.png)
