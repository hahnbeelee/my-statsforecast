...
| ARIMA (1,0,0)              | 1 0 0 | \$Y_t = + *1 Y*{t-1} + $| AR(1): AR(1): First-order regression model| |ARIMA (2, 0, 0)|2 0 0 |$Y_t = *0 + *1 Y*{t-1} + *2 Y*{t-2} + $| AR(2): Second-order regression model| |ARIMA (1, 1, 0)|1 1 0 |$Y_t = + Y*{t-1} + *1 (Y*{t-1}- Y\_{t-2})\$ | Differenced first-order      |
...
![](ARIMA_files/figure-markdown_strict/cell-7-output-1.png)
...
![](ARIMA_files/figure-markdown_strict/cell-8-output-2.png)
...
![](ARIMA_files/figure-markdown_strict/cell-10-output-1.png)
...
![](ARIMA_files/figure-markdown_strict/cell-16-output-1.png)
...
![](ARIMA_files/figure-markdown_strict/cell-17-output-1.png)
...
![](ARIMA_files/figure-markdown_strict/cell-18-output-1.png)
...
![](ARIMA_files/figure-markdown_strict/cell-28-output-1.png)
