...
possibilities for each component are: Error =\\A,M } , Trend =\\ N,A,A
d} and Seasonal =\\ N,A,M }
...
given by \$ *t=y_t-*{t-1}-b\_{t-1} (0,^2)\$. Substituting this into the
error correction equations for Holt’s linear method we obtain
...
![](/docs/models/Holt_files/figure-markdown_strict/cell-7-output-1.png)
...
![](/docs/models/Holt_files/figure-markdown_strict/cell-10-output-1.png)
...
![](/docs/models/Holt_files/figure-markdown_strict/cell-11-output-1.png)
...
![](/docs/models/Holt_files/figure-markdown_strict/cell-12-output-1.png)
...
![](/docs/models/Holt_files/figure-markdown_strict/cell-15-output-1.png)
...
`Holt Model`, they are listed below. For more information, visit the
[documentation](https://nixtla.github.io/statsforecast/src/core/models.html#holts-method).
...
![](/docs/models/Holt_files/figure-markdown_strict/cell-22-output-1.png)
...
![](/docs/models/Holt_files/figure-markdown_strict/cell-25-output-1.png)
...
![](/docs/models/Holt_files/figure-markdown_strict/cell-29-output-1.png)
...
![](/docs/models/Holt_files/figure-markdown_strict/cell-35-output-1.png)
...
![](/docs/models/Holt_files/figure-markdown_strict/cell-36-output-1.png)
