---
description: Step-by-step guide on using the `DynamicOptimizedTheta Model` with `Statsforecast`.
...
![](DynamicOptimizedTheta_files/figure-markdown_strict/cell-7-output-1.png)
...
![](DynamicOptimizedTheta_files/figure-markdown_strict/cell-13-output-1.png)
...
`DynamicOptimizedTheta Model`, they are listed below. For more
information, visit the
[documentation](https://nixtla.github.io/statsforecast/src/core/models.html#dynamicoptimizedtheta).
...
![](DynamicOptimizedTheta_files/figure-markdown_strict/cell-20-output-1.png)
...
![](DynamicOptimizedTheta_files/figure-markdown_strict/cell-23-output-1.png)
...
![](DynamicOptimizedTheta_files/figure-markdown_strict/cell-27-output-1.png)
...
![](DynamicOptimizedTheta_files/figure-markdown_strict/cell-32-output-1.png)
