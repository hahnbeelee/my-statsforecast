---
description: Step-by-step guide on using the `SeasonalExponentialSmoothing Model`
  with `Statsforecast`.
...
for \$h=1,2,\$. Hence, the naïve method assumes that the most recent
...
for \$h=1,2,\$ Hence, the average method assumes that all observations
...
![](SeasonalExponentialSmoothing_files/figure-markdown_strict/cell-7-output-1.png)
...
![](SeasonalExponentialSmoothing_files/figure-markdown_strict/cell-10-output-1.png)
...
![](SeasonalExponentialSmoothing_files/figure-markdown_strict/cell-11-output-1.png)
...
![](SeasonalExponentialSmoothing_files/figure-markdown_strict/cell-12-output-1.png)
...
![](SeasonalExponentialSmoothing_files/figure-markdown_strict/cell-15-output-1.png)
...
`SeasonalExponentialSmoothing Model`, they are listed below. For more
information, visit the
[documentation](https://nixtla.github.io/statsforecast/src/core/models.html#seasonalsmooth).
...
![](SeasonalExponentialSmoothing_files/figure-markdown_strict/cell-22-output-1.png)
...
![](SeasonalExponentialSmoothing_files/figure-markdown_strict/cell-25-output-1.png)
...
![](SeasonalExponentialSmoothing_files/figure-markdown_strict/cell-28-output-1.png)
...
![](SeasonalExponentialSmoothing_files/figure-markdown_strict/cell-31-output-1.png)
