---
description: Step-by-step guide on using the `IMAPA Model` with `Statsforecast`.
output-file: imapa.html
title: IMAPA Model
...
## IMAPA Method <a class="anchor" id="model"></a>
...
![](IMAPA_files/figure-markdown_strict/cell-7-output-1.png)
...
![](IMAPA_files/figure-markdown_strict/cell-8-output-1.png)
...
![](IMAPA_files/figure-markdown_strict/cell-10-output-2.png)
...
![](IMAPA_files/figure-markdown_strict/cell-13-output-1.png)

## Implementation of IMAPA Method with StatsForecast <a class="anchor" id="implementation"></a>

To also know more about the parameters of the functions of the
`IMAPA Model`, they are listed below. For more information, visit the
[documentation](https://nixtla.github.io/statsforecast/src/core/models.html#imapa).
...
![](IMAPA_files/figure-markdown_strict/cell-22-output-1.png)
...
![](IMAPA_files/figure-markdown_strict/cell-26-output-1.png)
...
![](IMAPA_files/figure-markdown_strict/cell-27-output-1.png)
