---
description: Step-by-step guide on using the `CrostonSBA Model` with `Statsforecast`.
output-file: crostonsba.html
...
## Croston SBA Model <a class="anchor" id="model"></a>
...
![](CrostonSBA_files/figure-markdown_strict/cell-7-output-1.png)
...
![](CrostonSBA_files/figure-markdown_strict/cell-8-output-1.png)
...
![](CrostonSBA_files/figure-markdown_strict/cell-10-output-2.png)
...
![](CrostonSBA_files/figure-markdown_strict/cell-13-output-1.png)

## Implementation of CrostonSBA with StatsForecast <a class="anchor" id="implementation"></a>

To also know more about the parameters of the functions of the
`CrostonSBA Model`, they are listed below. For more information, visit
the
[documentation](https://nixtla.github.io/statsforecast/src/core/models.html#crostonsba).
...
![](CrostonSBA_files/figure-markdown_strict/cell-22-output-1.png)
...
![](CrostonSBA_files/figure-markdown_strict/cell-26-output-1.png)
...
![](CrostonSBA_files/figure-markdown_strict/cell-27-output-1.png)
...
1.  The actual values.
2.  The forecasts, in this case, `Croston SBA Model`.
