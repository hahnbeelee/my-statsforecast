...
example visit the [Quick Start](./1_Getting_Started_short.ipynb).
...
-   Forecasting at scale using clusters on the cloud.
    -   [Forecast the M5 Dataset in
        5min](../how-to-guides/ETS_ray_m5.ipynb) using Ray clusters.
    -   [Forecast the M5 Dataset in
        5min](../how-to-guides/Prophet_spark_m5.ipynb) using Spark
        clusters.
...
-   Training models on Multiple Seasonalities.
    -   Learn to use multiple seasonality in this [Electricity Load
        forecasting](../tutorials/ElectricityLoadForecasting.ipynb)
        tutorial.
-   Using external regressors or exogenous variables
    -   Follow this tutorial to [include exogenous
        variables](../how-to-guides/Exogenous.ipynb) like weather or
...
instructions on [how to install StatsForecast](./0_Installation.ipynb).
...
![](2_Getting_Started_complete_files/figure-markdown_strict/cell-5-output-2.png)
...
-   `models`: a list of models. Select the models you want from
    [models](../../src/core/models.ipynb) and import them.
...
![](2_Getting_Started_complete_files/figure-markdown_strict/cell-10-output-1.png)
...
![](2_Getting_Started_complete_files/figure-markdown_strict/cell-11-output-1.png)
...
![](2_Getting_Started_complete_files/figure-markdown_strict/cell-12-output-1.png)
...
First import the desired error metrics from `mlforecast.losses`. Then
...
![](2_Getting_Started_complete_files/figure-markdown_strict/cell-19-output-1.png)
...
![](2_Getting_Started_complete_files/figure-markdown_strict/cell-22-output-1.png)
