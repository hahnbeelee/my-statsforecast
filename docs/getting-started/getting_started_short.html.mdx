...
series](./2_Getting_Started_complete.ipynb) guide.
...
[models](../../src/core/models.ipynb) and import them. For this example,
we will use a
...
![](1_Getting_Started_short_files/figure-markdown_strict/cell-6-output-2.png)
...
-   Build and end-to-end forecasting pipeline following best practices
    in [End to End Walkthrough](./2_Getting_Started_complete.ipynb)
-   [Forecast millions of
    series](../how-to-guides/Prophet_spark_m5.ipynb) in a scalable
    cluster in the cloud using Spark and Nixtla
-   [Detect anomalies](../tutorials/AnomalyDetection.ipynb) in your past
    observations
