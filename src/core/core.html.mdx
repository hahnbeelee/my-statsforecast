...
<a
href="https://github.com/Nixtla/statsforecast/blob/main/statsforecast/core.py#L1574"
...
|------|------------------|-------------------------|-------------------------|
| models         | typing.List\[typing.Any\]                                                               |             | List of instantiated objects models.StatsForecast.                                                                                                                                                                                                          |
...
| df             | typing.Union\[pandas.core.frame.DataFrame, polars.dataframe.frame.DataFrame, NoneType\] | None        | DataFrame with columns \[`unique_id`, `ds`, `y`\] and exogenous.                                                                                                                                                                                            |
| sort_df        | bool                                                                                    | True        | If True, sort `df` by \[`unique_id`,`ds`\].                                                                                                                                                                                                                 |
| fallback_model | typing.Optional\[typing.Any\]                                                           | None        | Model to be used if a model fails. <br>Only works with the [`forecast`](https://Nixtla.github.io/statsforecast/src/ets.html#forecast) and [`cross_validation`](https://Nixtla.github.io/statsforecast/src/distributed.utils.html#cross_validation) methods. |
...
|      | unique_id | ds         | y        |
|------|-----------|------------|----------|
| 218  | 0         | 2000-08-06 | 1.212726 |
| 219  | 0         | 2000-08-07 | 2.442669 |
| 220  | 0         | 2000-08-08 | 3.339940 |
| 221  | 0         | 2000-08-09 | 4.228065 |
| 315  | 1         | 2000-04-03 | 0.048275 |
| 316  | 1         | 2000-04-04 | 1.128070 |
| 317  | 1         | 2000-04-05 | 2.295968 |
| 318  | 1         | 2000-04-06 | 3.238239 |
| 482  | 2         | 2000-06-12 | 6.480128 |
| 483  | 2         | 2000-06-13 | 0.036217 |
| 484  | 2         | 2000-06-14 | 1.009650 |
| 485  | 2         | 2000-06-15 | 2.489787 |
| 724  | 3         | 2000-08-26 | 3.289840 |
| 725  | 3         | 2000-08-27 | 4.227949 |
| 726  | 3         | 2000-08-28 | 5.321176 |
| 727  | 3         | 2000-08-29 | 6.127013 |
| 1097 | 4         | 2001-01-04 | 5.403709 |
| 1098 | 4         | 2001-01-05 | 6.081779 |
| 1099 | 4         | 2001-01-06 | 0.438420 |
| 1100 | 4         | 2001-01-07 | 1.386855 |
| 1398 | 5         | 2000-10-24 | 5.011166 |
| 1399 | 5         | 2000-10-25 | 6.397153 |
| 1400 | 5         | 2000-10-26 | 0.462146 |
| 1401 | 5         | 2000-10-27 | 1.253125 |
| 1643 | 6         | 2000-08-29 | 5.407805 |
| 1644 | 6         | 2000-08-30 | 6.340789 |
| 1645 | 6         | 2000-08-31 | 0.202894 |
| 1646 | 6         | 2000-09-01 | 1.491204 |
| 2052 | 7         | 2001-02-09 | 1.068102 |
| 2053 | 7         | 2001-02-10 | 2.233974 |
| 2054 | 7         | 2001-02-11 | 3.484143 |
| 2055 | 7         | 2001-02-12 | 4.176505 |
| 2111 | 8         | 2000-02-25 | 4.110373 |
| 2112 | 8         | 2000-02-26 | 5.483879 |
| 2113 | 8         | 2000-02-27 | 6.068916 |
| 2114 | 8         | 2000-02-28 | 0.040499 |
...
<a
href="https://github.com/Nixtla/statsforecast/blob/main/statsforecast/core.py#L856"
target="_blank" style="float:right; font-size:smaller">source</a>
...
|                      | **Type**                                                                                | **Default** | **Details**                                                                                                                                                                                                                    |
|------|------------------|-------------------------|-------------------------|
| df                   | typing.Union\[pandas.core.frame.DataFrame, polars.dataframe.frame.DataFrame, NoneType\] | None        | DataFrame with columns \[`unique_id`, `ds`, `y`\] and exogenous.<br>If None, the [`StatsForecast`](https://Nixtla.github.io/statsforecast/src/core/core.html#statsforecast) class should have been instantiated<br>using `df`. |
| sort_df              | bool                                                                                    | True        | If True, sort `df` by \[`unique_id`,`ds`\].                                                                                                                                                                                    |
| prediction_intervals | typing.Optional\[statsforecast.utils.ConformalIntervals\]                               | None        | Configuration to calibrate prediction intervals (Conformal Prediction).                                                                                                                                                        |
...
<a
href="https://github.com/Nixtla/statsforecast/blob/main/statsforecast/core.py#L945"
target="_blank" style="float:right; font-size:smaller">source</a>
...
| X_df        | typing.Union\[pandas.core.frame.DataFrame, polars.dataframe.frame.DataFrame, NoneType\] | None        | DataFrame with \[`unique_id`, `ds`\] columns and `df`’s future exogenous.                                           |
| level       | typing.Optional\[typing.List\[int\]\]                                                   | None        | Confidence levels between 0 and 100 for prediction intervals.                                                       |
...
<a
href="https://github.com/Nixtla/statsforecast/blob/main/statsforecast/core.py#L991"
target="_blank" style="float:right; font-size:smaller">source</a>
...
|------|------------------|-------------------------|-------------------------|
| h                    | int                                                                                     |             | Forecast horizon.                                                                                                                                                                                                                        |
| df                   | typing.Union\[pandas.core.frame.DataFrame, polars.dataframe.frame.DataFrame, NoneType\] | None        | DataFrame with columns \[`unique_id`, `ds`, `y`\] and exogenous variables.<br>If None, the [`StatsForecast`](https://Nixtla.github.io/statsforecast/src/core/core.html#statsforecast) class should have been instantiated<br>using `df`. |
| X_df                 | typing.Union\[pandas.core.frame.DataFrame, polars.dataframe.frame.DataFrame, NoneType\] | None        | DataFrame with \[`unique_id`, `ds`\] columns and `df`’s future exogenous.                                                                                                                                                                |
| level                | typing.Optional\[typing.List\[int\]\]                                                   | None        | Confidence levels between 0 and 100 for prediction intervals.                                                                                                                                                                            |
| sort_df              | bool                                                                                    | True        | If True, sort `df` by \[`unique_id`,`ds`\].                                                                                                                                                                                              |
| prediction_intervals | typing.Optional\[statsforecast.utils.ConformalIntervals\]                               | None        | Configuration to calibrate prediction intervals (Conformal Prediction).                                                                                                                                                                  |
...
<a
href="https://github.com/Nixtla/statsforecast/blob/main/statsforecast/core.py#L1050"
target="_blank" style="float:right; font-size:smaller">source</a>
...
| 1.0       | 1961-01-02 | 482.846191 | 432.0 |
...
<a
href="https://github.com/Nixtla/statsforecast/blob/main/statsforecast/core.py#L1114"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/Nixtla/statsforecast/blob/main/statsforecast/core.py#L1144"
target="_blank" style="float:right; font-size:smaller">source</a>
...
| test_size            | typing.Optional\[int\]                                                                  | None        | Length of test size. If passed, set `n_windows=None`.                                                                                                                                                                          |
| input_size           | typing.Optional\[int\]                                                                  | None        | Input size for each window, if not none rolled windows.                                                                                                                                                                        |
| level                | typing.Optional\[typing.List\[int\]\]                                                   | None        | Confidence levels between 0 and 100 for prediction intervals.                                                                                                                                                                  |
...
``` text
Cross Validation Time Series 1:   0%|          | 0/2 [00:00<?, ?it/s]Cross Validation Time Series 1: 100%|##########| 2/2 [00:00<00:00, 7002.18it/s]
```
...
<a
href="https://github.com/Nixtla/statsforecast/blob/main/statsforecast/core.py#L1269"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/Nixtla/statsforecast/blob/main/statsforecast/core.py#L1463"
target="_blank" style="float:right; font-size:smaller">source</a>
...
|                     | **Type**                                                                                | **Default** | **Details**                                                                                                                                                                                              |
|------|------------------|-------------------------|-------------------------|
| df                  | typing.Union\[pandas.core.frame.DataFrame, polars.dataframe.frame.DataFrame\]           |             | DataFrame with columns \[`unique_id`, `ds`, `y`\].                                                                                                                                                       |
| forecasts_df        | typing.Union\[pandas.core.frame.DataFrame, polars.dataframe.frame.DataFrame, NoneType\] | None        | DataFrame with columns \[`unique_id`, `ds`\] and models.                                                                                                                                                 |
| unique_ids          | typing.Union\[typing.List\[str\], NoneType, numpy.ndarray\]                             | None        | Time Series to plot.<br>If None, time series are selected randomly.                                                                                                                                      |
| plot_random         | bool                                                                                    | True        | Select time series to plot randomly.                                                                                                                                                                     |
| models              | typing.Optional\[typing.List\[str\]\]                                                   | None        | List of models to plot.                                                                                                                                                                                  |
| level               | typing.Optional\[typing.List\[float\]\]                                                 | None        | List of prediction intervals to plot if paseed.                                                                                                                                                          |
| max_insample_length | typing.Optional\[int\]                                                                  | None        | Max number of train/insample observations to be plotted.                                                                                                                                                 |
...
| resampler_kwargs    | typing.Optional\[typing.Dict\]                                                          | None        | Kwargs to be passed to plotly-resampler constructor. <br>For further custumization (“show_dash”) call the method,<br>store the plotting object and add the extra arguments to<br>its `show_dash` method. |
