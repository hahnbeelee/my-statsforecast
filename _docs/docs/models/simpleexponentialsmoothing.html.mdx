---
description: Step-by-step guide on using the `SimpleExponentialSmoothing Model` with
  `Statsforecast`.
...
![](SimpleExponentialSmoothing_files/figure-markdown_strict/cell-7-output-1.png)
...
![](SimpleExponentialSmoothing_files/figure-markdown_strict/cell-8-output-1.png)
...
![](SimpleExponentialSmoothing_files/figure-markdown_strict/cell-11-output-1.png)
...
`SimpleExponentialSmoothing Model`, they are listed below. For more
...
![](SimpleExponentialSmoothing_files/figure-markdown_strict/cell-18-output-1.png)
...
![](SimpleExponentialSmoothing_files/figure-markdown_strict/cell-21-output-1.png)
...
![](SimpleExponentialSmoothing_files/figure-markdown_strict/cell-25-output-2.png)
...
![](SimpleExponentialSmoothing_files/figure-markdown_strict/cell-26-output-1.png)
