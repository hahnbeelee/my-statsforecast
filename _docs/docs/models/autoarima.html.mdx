...
| ARIMA (1,0,0)              | 1 0 0 | \$Y_t = + *1 Y*{t-1} + $| AR(1): AR(1): First-order regression model| |ARIMA (2, 0, 0)|2 0 0 |$Y_t = *0 + *1 Y*{t-1} + *2 Y*{t-2} + $| AR(2): Second-order regression model| |ARIMA (1, 1, 0)|1 1 0 |$Y_t = + Y*{t-1} + *1 (Y*{t-1}- Y\_{t-2})\$ | Differenced first-order autoregressive model |
...
![](AutoARIMA_files/figure-markdown_strict/cell-8-output-1.png)
...
![](AutoARIMA_files/figure-markdown_strict/cell-9-output-1.png)
...
![](AutoARIMA_files/figure-markdown_strict/cell-10-output-1.png)
...
![](AutoARIMA_files/figure-markdown_strict/cell-13-output-1.png)
...
`AutoARIMA Model`, they are listed below. For more information, visit
the
...
the form `ARIMA(1,0,0)(0,1,2)[12]`, this means that our model contains
...
![](AutoARIMA_files/figure-markdown_strict/cell-21-output-1.png)
...
![](AutoARIMA_files/figure-markdown_strict/cell-26-output-1.png)
...
![](AutoARIMA_files/figure-markdown_strict/cell-30-output-1.png)
...
![](AutoARIMA_files/figure-markdown_strict/cell-31-output-1.png)
