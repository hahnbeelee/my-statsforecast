...
<a href="https://colab.research.google.com/github/Nixtla/statsforecast/blob/main/nbs/examples/GARCH_tutorial.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>
...
![](GARCH_tutorial_files/figure-markdown_strict/cell-8-output-2.png)
...
![](GARCH_tutorial_files/figure-markdown_strict/cell-10-output-1.png)
...
![](GARCH_tutorial_files/figure-markdown_strict/cell-15-output-1.png)
...
![](GARCH_tutorial_files/figure-markdown_strict/cell-21-output-1.png)

```python
StatsForecast.plot(returns, forecasts, level=levels, unique_ids = ['MSFT'], models = ['ARCH(2)'])
```

![](GARCH_tutorial_files/figure-markdown_strict/cell-22-output-1.png)

```python
StatsForecast.plot(returns, forecasts, level=levels, unique_ids = ['NFLX'], models = ['ARCH(1)'])
```

![](GARCH_tutorial_files/figure-markdown_strict/cell-23-output-1.png)
